...
from src.entities.customer_profiles.models import CustomerProfileOrm  # noqa: F401
from src.entities.notary_profiles.models import NotaryProfileOrm  # noqa: F401
...
config.set_main_option(
    "sqlalchemy.url",
    f"postgresql://{app_config.db.username}:{app_config.db.password.get_secret_value()}@{app_config.db.host}:{app_config.db.port}/{app_config.db.name}",
)
